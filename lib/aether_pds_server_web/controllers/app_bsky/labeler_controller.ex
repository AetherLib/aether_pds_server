defmodule AetherPdsServerWeb.AppBsky.LabelerController do
  ...
  """
  def get_blocks(conn, _) do
  end

  @doc """
  GET /xrpc/app.bsky.graph.getFollowers
  """
  def get_followers(conn, _) do
  end

  @doc """
  GET /xrpc/app.bsky.graph.getFollows
  """
  def get_follows(conn, _) do
  end
  ...
  """
  def get_mutes(conn, _) do
  end

  @doc """
  GET /xrpc/app.bsky.graph.getRelationships
  """
  def get_relationships(conn, _) do
  end
  ...
  @doc """
  GET /xrpc/app.bsky.graph.muteActorList
  """
  def mute_actor_list(conn, _) do
  end

  @doc """
  GET /xrpc/app.bsky.graph.muteActor
  """
  def mute_actor(conn, _) do
  end

  @doc """
  GET /xrpc/app.bsky.graph.muteThread
  """
  def mute_thread(conn, _) do
  end
  ...
  @doc """
  GET /xrpc/app.bsky.graph.unmuteActorList
  """
  def unmute_actor_list(conn, _) do
  end

  @doc """
  GET /xrpc/app.bsky.graph.unmuteActor
  """
  def unmute_actor(conn, _) do
  end

  @doc """
  GET /xrpc/app.bsky.graph.unmuteThread
  """
  def unmute_thread(conn, _) do
  end
end
