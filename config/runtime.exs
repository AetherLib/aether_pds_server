...
#
#     PHX_SERVER=true bin/aether_pds_server start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :aether_pds_server, AetherPDSServerWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :aether_pds_server, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :aether_pds_server, AetherPDSServerWeb.Endpoint,
    ...
    http: [
      ...
      ip: {0, 0, 0, 0, 0, 0, 0, 0},
      port: port,
      # Increase read timeout for large blob uploads
      read_timeout: 60_000,
      # Ensure HTTP/2 works properly with proxies
      http_2_options: [
  ...
  #
  #     config :aether_pds_server, AetherPDSServer.Mailer,
